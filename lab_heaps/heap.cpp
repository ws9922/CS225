...
bool heap<T, Compare>::hasAChild(size_t currentIdx) const
{
    ...
    size_t lastParent = parent(lastIdx);
    return currentIdx <= lastParent;
}
...
void heap<T, Compare>::heapifyDown(size_t currentIdx)
{
    ...
    size_t leastChild = maxPriorityChild(currentIdx);
    if (higherPriority(_elems[leastChild], _elems[currentIdx])){
        std::swap(_elems[leastChild], _elems[currentIdx]);
